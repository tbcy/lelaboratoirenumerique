...
@section('description', 'Découvrez mes projets phares : Youplago, application mobile d\'organisation d\'événements, et Batibid, plateforme immobilière complète.')
...
<!-- Data Migration -->
<section id="data-migration" class="py-16 md:py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid md:grid-cols-2 gap-12 items-center">
            <!-- Info -->
            <div>
